...
@section('title', 'DogMeet | Új kutya felvétele')
...
@section('content')
    <div class="container containerStyle">
        ...
        <div class="row">
            ...
            <h1 class="text-center my-4 dog editTitle">Új kutya felvétele</h1>
        </div>

        <div class="row">
            <div class="col-12 col-md-8 offset-md-2">
                {!! Form::open(['route' => 'dog.storedata', 'method' => 'post']) !!}
                ...
                <div class="row my-3 text-center">
                    <div class="col-12 col-md-6 offset-md-3">
                        {{Form::submit('Hozzáadás', ['class' => 'btn brownBtn'])}}
                    </div>
                </div>
                {!! Form::close() !!}
            </div>
